...
namespace LiminalDungeonGeneration
{
    public static class DefaultRoomGenerator
    {
        ...
        public static DungeonModule GenerateRandomRoom()
        {
            ...
            MeshRoom room = meshBuilder.BuildRoom(groundPlan, height, MaterialHandler.Singleton.GetRandomFloorMaterial(), MaterialHandler.Singleton.GetRandomCeilingMaterial(), MaterialHandler.Singleton.GetRandomFloorMaterial(), LiminalDungeonGenerator.FLOOR_TEXTURE_SCALING, LiminalDungeonGenerator.WALL_TEXTURE_SCALING);
