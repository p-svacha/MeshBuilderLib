...
namespace LiminalDungeonGeneration
{
    public static class HallGenerator
    {
        ...
        public static DungeonModule GenerateRandomHall()
        {
            ...
            MeshRoom room = meshBuilder.BuildRoom(groundPlan, hallHeight, MaterialHandler.Singleton.GetRandomFloorMaterial(), MaterialHandler.Singleton.GetRandomWallMaterial(), MaterialHandler.Singleton.GetRandomCeilingMaterial(), LiminalDungeonGenerator.FLOOR_TEXTURE_SCALING, LiminalDungeonGenerator.WALL_TEXTURE_SCALING);
