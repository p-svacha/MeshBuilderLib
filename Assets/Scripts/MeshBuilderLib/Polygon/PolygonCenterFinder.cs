...
/// <summary>
/// A helper class to find the point of inaccessability inside a polygon.
/// </summary>
public static class PolygonCenterFinder
{
    ...
    /// </summary>
    public static Vector2 GetPolyLabel(float[][][] polygon, float precision = 0.5f)
    {
    ...
    public static float[][][] ConvertPolygonToFloatArray(Polygon p)
    {
        // this is a float[][]

        var polygon = new float[1][][];
        polygon[0] = new float[p.Points.Count][];
    ...
    private class PriorityQueue<TPriority, TItem>
    {
